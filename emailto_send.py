    ...
    <table id="Table_01" width="680" height="1621" border="0" cellpadding="0" cellspacing="0" align="center" style="font-family:Arial Narrow, Helvetica, sans-serif; border:1px solid #999;">
        ...
        <tr>
            <td colspan="12" style="text-align:center;">
                <img src="https://qascioto4seeapp.azurewebsites.net/public/vendor/images/logo/mailer_4seeInsights2_03.jpg" width="172" height="90" alt="" style="text-align:center;width: 100%;float: left;"></a></td>
        </tr>
        <tr>
            <td colspan="12">
